...
AI로 무엇이든 빠르게 만들 수 있는 시대입니다.  
하지만 저는 기술의 화려함보다 **기본의 가치**를 믿습니다.

진정한 개발자의 힘은 *“왜 필요한가”* 를 이해하려는 사고에서 비롯된다고 생각합니다.  
저는 **호기심**을 바탕으로 **필요성을 느끼며 배우고**,  
그 과정에서 지식을 **빠르고 깊게 체득**합니다.

> 꾸준히 탐구하고 성장하는 개발자가 되고자 합니다.
...
- 기업 코딩 테스트 대비 문제 풀이 및 복기 기록 ( AI 0%!! , 전부 수 작업)
📒 **Notion 정리 노트**  
...
- **학점:** 4.15 / 4.50  
- **기타:**  
  - 2025학년도 1학기 President’s List (4.5 / 19학점)  
  - 2025학년도 2학기 President’s List  
...
| 드림학기제 우수상 (단독) | 건국대학교 | 프로젝트: *EmoChat* |
...
- **보이노시스 (ML Engineer Intern)**  
  - 멀티모달 스트레스 인식 모델 연구  
  - Whisper 기반 STT 프로젝트 진행  

- **건국대학교 학부연구생 (AI Vision Lab)**  
  - 오디오 / 비전 기반 감정·스트레스 분류 연구  
...
- 경량화 음성 스트레스 모델 (Knowledge Distillation)
...
> 음성 감정(7-class) + 스트레스(2-class) 인식 및 GPT 기반 응답 생성

**Highlights**
- Whisper STT · DistilRoBERTa · StudentNet  
  *(F1-score +17pp 향상)*  
- GPT + Pinecone Vector DB 기반 RAG Context  
...
2. **React.js & Node.js** – 웹 애플리케이션 아키텍처 심화  
